import Chennai from "../../Images/Home & PlaceToVisit/Chennai/Chennai.jpeg";
import Marina_Beach from "../../Images/Home & PlaceToVisit/Chennai/Marina_Beach.jpeg";
import MGR_Film_City from "../../Images/Home & PlaceToVisit/Chennai/MGR_Film_City.jpeg";
import Marundeeswarar_Temple from "../../Images/Home & PlaceToVisit/Chennai/Marundeeswarar_Temple.jpeg";
import Breezy_Beach from "../../Images/Home & PlaceToVisit/Chennai/Breezy_Beach.jpeg";
...
const cardItem = [
    ...
    },
    {
        ...
        overview : {
            overview1 : "Having been established in the year 1994, a considerably new structure, the MGR Film city is managed by the Government of Tamil Nadu in loving memory of MG Ramachandran who was not only a crowd-pleasing tamil actor but also a longtime CM of Tamil Nadu.",
    ...
    },
    {
        ...
        description : "Situated in the city of Chennai in Tamil Nadu, Marina Beach is a natural urban beach along the Bay of Bengal...",
        overview : {
            overview1 : "Breezy Beach lays in the remote and serene neighbourhood of Valmiki Nagar in Chennai. Being smaller and less polluted, its a perfect getaway for anyone looking for a peaceful evening.",
            overview2 : "This beach is not as popular and known as the Elliots beach, and is hence more quiet and peaceful. Evenings are very pleasant and breezy here, and in the recent years, lots of tourists have been attracted towards this beach for its beauty. Those looking for an amiable, refreshing and breezy place to chill out and have fun, the Breezy beach of Chennai is the place to be."
        }
    }
];

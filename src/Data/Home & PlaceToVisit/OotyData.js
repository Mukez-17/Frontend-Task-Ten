import Ooty from "../../Images/Home & PlaceToVisit/Ooty/Ooty.jpeg";
import Nilgiri_Mountain_Railway from "../../Images/Home & PlaceToVisit/Ooty/Nilgiri_Mountain_Railway.jpeg";
import Ooty_Botanical_Garden from "../../Images/Home & PlaceToVisit/Ooty/ooty_Botanical_Garden.jpeg";
import Emerald_Lake from "../../Images/Home & PlaceToVisit/Ooty/Emerald_Lake.jpeg";
import Dolphin_Nose from "../../Images/Home & PlaceToVisit/Ooty/Dolphins_Nose.jpeg";
...
const cardItem = [
    {
        ...
        overview : {
            overview1 : "Nilgin Mountain Railway, also known as Toy Train in Ooty, is one of the key attractions of the popular hill station Ooty. Such is the train's popularity and history that it was declared as a World Heritage Site by UNESCO in 2005. Started in the year 1899, it has continued to charm its visitors over the past many years winding its way through the best of nature.",
            overview2 : "The Toy Train covers a distance of total 46 km in a span of 5 hours and takes one through a truly spectacular journey filled with picturesque views en route. Another fascinating feature of the train is that its youngest X-class locomotive is over 50 years old and the oldest is 80 years old."
        }
    },
    {
        id : 2,

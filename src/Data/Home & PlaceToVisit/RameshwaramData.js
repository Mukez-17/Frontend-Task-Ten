import Rameshwaram from "../../Images/Home & PlaceToVisit/Rameshwaram/Rameshwaram.jpeg"; 
import DhanushKodi_Temple from "../../Images/Home & PlaceToVisit/Rameshwaram/DhanushKodi_Temple.jpeg"; 
import Lakshmana_Temple from "../../Images/Home & PlaceToVisit/Rameshwaram/Lakshmana_Temple.jpeg"; 
import Rameshwaram_Temple from "../../Images/Home & PlaceToVisit/Rameshwaram/Rameshwaram_Temple.jpeg";
import Villoondi_Tirtham from "../../Images/Home & PlaceToVisit/Rameshwaram/Villoondi_Tirtham.jpeg";
...
const titleCard = {
    ...
    content : {
        content1 : "Rameshwaram is located on a beautiful island in the South Indian state of Tamil Nadu. It is separated by a small Pamban channel from Sri Lanka. According to Hindu mythology, this is the place where Lord Rama created a bridge across the sea to Sri Lanka.",
        content2 : "Renowned for its magnificent prakaras with massive sculptured pillars on either side, The Ramanathaswamy Temple houses the longest corridor in the world. Agniteertham is famous for its sacred waters and Pilgrims perform poojas in honour of their ancestors at this seashore. The five-faced Hanuman Temple holds the floating stone which was used to build the bridge between India and Sri Lanka. Rameshwaram has the first sea bridge connecting the town of Mandapam with Pamban Island, and Rameswaram."
    }
}
...
const cardItem = [
    {
        id : 1,
        placeName : "Dhanushkodi Temple",
        img : DhanushKodi_Temple,
        description : "Dhanushkodi was until a few years ago a wonderful temple on the southern tip of India. However, due to a...",
        overview : {
            overview1 : "Dhanushkodi was until a few years ago a wonderful temple on the southern tip of India. However, due to a natural calamity, the cyclone, it got completely washed away.",
    ...
    },
    {
        ...
        img : Lakshmana_Temple,
        description : "Lakshmana Tirtham had been constructed in the loving memory of Lord Lakshman, brother of Lord Rama...",
        overview : {
            ...
            overview2 : "Several wonderful sculptures of Lord Lakshmana have been carved out from marble and the temple has the statues of lord Rama and Goddess Sita too which signifies the spirit of unitedness that exisited between them."
        }
    },
    {
        id : 3,

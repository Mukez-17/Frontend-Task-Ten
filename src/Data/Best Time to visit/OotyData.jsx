import Mountain_Railway_Source from "../../Images/Best Time To VIsit/Ooty/Mountain_Railway_Source.jpeg";
import Ooty_Lake_Source from "../../Images/Best Time To VIsit/Ooty/Ooty_Lake_Source.jpeg";
import Trekking_Ooty_Source from "../../Images/Best Time To VIsit/Ooty/Trekking_Ooty_Source.jpeg";
...
const offCanvasContent = [
    {
        id : 1,
        title : "Ooty in Summer (March- June)",
        imgsrc : Mountain_Railway_Source,
        imgalt : "Mountain Railway Source",
    ...
    {
        id : 2,
        title : "Ooty in Winter (October - March)",
        imgsrc : Ooty_Lake_Source,
        imgalt : "Ooty Lake Source",
    ...
    {
        id : 3,
        title : "Ooty in Monsoon (July - September)",
        imgsrc : Trekking_Ooty_Source,
        imgalt : "Trekking Ooty Source",

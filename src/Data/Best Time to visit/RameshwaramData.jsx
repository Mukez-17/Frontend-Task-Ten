import Railway_Bridge_Source from "../../Images/Best Time To VIsit/Rameshwaram/Railway_Bridge_Source.jpeg";
import Lighthouse_Source from "../../Images/Best Time To VIsit/Rameshwaram/Light_House_Source.jpeg";
import Pilgrims_Temple_Source from "../../Images/Best Time To VIsit/Rameshwaram/Pilgrims_Temple_Source.jpeg";
...
const offCanvasContent = [
    {
        id : 1,
        title : "Rameshwaram in Winter (December- February)",
        imgsrc : Railway_Bridge_Source,
        imgalt : "Railway Bridge Source",
        placeholder : "Railway Bridge Source",
    ...
    {
        id : 2,
        title : "Rameshwaram in Monsoon (July - October)",
        imgsrc : Lighthouse_Source,
        imgalt : "Lighthouse SOurce",
    ...
    {
        id : 3,
        title : "Rameshwaram in Summer (March - June)",
        imgsrc : Pilgrims_Temple_Source,
        imgalt : "Pilgrims Temple Source",
...
export {titleContent, offCanvasContent};